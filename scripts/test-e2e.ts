...
process.env.INPUT_AI_PROVIDER = process.env.AI_PROVIDER || 'custom';
process.env.INPUT_AI_API_KEY = process.env.AI_API_KEY;
process.env.INPUT_AI_MODEL = process.env.AI_MODEL || 'minimax-m2.1';
process.env.INPUT_AI_BASE_URL = process.env.AI_BASE_URL || "https://api.minimax.io/v1/text/chatcompletion_v2"
